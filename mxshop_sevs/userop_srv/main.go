...
import (
	...
	"mxshop_sevs/userop_srv/handler"
	"mxshop_sevs/userop_srv/initialize"
	"mxshop_sevs/userop_srv/model/proto"
	"mxshop_sevs/userop_srv/utils"
	"mxshop_sevs/userop_srv/utils/register/consul"
	"net"
	"os"
	"os/signal"
	"syscall"
