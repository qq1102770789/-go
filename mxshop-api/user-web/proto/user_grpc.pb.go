...
type UserClient interface {
	...
	UpdateUser(ctx context.Context, in *UpdateUserInfo, opts ...grpc.CallOption) (*Emptymessage, error)
...
func (c *userClient) UpdateUser(ctx context.Context, in *UpdateUserInfo, opts ...grpc.CallOption) (*Emptymessage, error) {
...
type UserServer interface {
	...
	UpdateUser(context.Context, *UpdateUserInfo) (*Emptymessage, error)
...
func (UnimplementedUserServer) UpdateUser(context.Context, *UpdateUserInfo) (*Emptymessage, error) {
